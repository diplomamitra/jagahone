          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-14">
            ...
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <p
                ...
                style={{ fontFamily: "mattermedium" }}
              >
                Manage reviews, track local rankings, publish Google Business
                Profile updates, and control multiple business locations from
            ...
            <div className="w-full max-w-[380px] bg-white rounded-[30px] p-6 sm:p-8 shadow-2xl">
              ...
              <div className="text-center">
                ...
                <p
                  ...
                  style={{ fontFamily: "mattermedium" }}
                >
                  Built for local businesses, agencies and multi-location
                  brands.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 mt-8">
                <NavLink
                 to="https://wa.me/+919306225156"
                  className="text-center w-full bg-green-600 hover:bg-green-700 text-white py-4 rounded-2xl text-lg transition-all shadow-lg"
                  style={{ fontFamily: "mattermedium" }}
                >
                  Start Free Trial
                </NavLink>
                ...
                <NavLink
                 to="/demo"
                  className="text-center w-full border border-gray-200 hover:border-green-300 hover:bg-green-50 text-[#0f172a] py-4 rounded-2xl text-lg transition-all"
                  style={{ fontFamily: "mattermedium" }}
                >
                  Book Free Demo
                </NavLink>
