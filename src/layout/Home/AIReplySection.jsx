        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          <div className="max-w-2xl order-1 lg:order-2">
            ...
            <h2
              ...
              style={{ fontFamily: "mattermedium" }}
            >
              Never Write Review Replies Manually Again
            </h2>
            ...
            <p
              ...
              style={{ fontFamily: "mattermedium" }}
            >
              Generate professional AI-powered review replies instantly,
              improve customer engagement, and save hours managing your
              Google Business Profile conversations.
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "mattermedium" }}
                  >
                    Reply to reviews instantly and improve trust.
                  </p>
                </div>
              </div>
            </div>
